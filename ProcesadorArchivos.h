...
int readCompressedFile(const std::string& filename); // Nuevo prototipo de función
int readEncryptedFile(const std::string& filename);  // Nuevo prototipo de función

#endif // ProcesadorArchivos_h
